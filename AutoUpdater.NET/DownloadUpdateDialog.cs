...
internal partial class DownloadUpdateDialog : XtraForm
{
    ...
    private   void DownloadUpdateDialogShown(object sender, EventArgs e)
    {
    ...
    private  void OnDownloadProgressChanged(object sender, DownloadProgressChangedEventArgs e)
    {
        ...
        else
        {
            ...
            if (totalSeconds > 0)
            {
                ...
                labelInformation.Text = $"以{BytesToString(bytesPerSecond)}/s下载";
    ...
    private void WebClientOnDownloadFileCompleted(object sender, AsyncCompletedEventArgs asyncCompletedEventArgs)
    {
        ...
        try
        {
            ...
            {
                throw new WebException("无法确定更新文件的文件名！");
            }
    ...
    private static void CompareChecksum(string fileName, CheckSum checksum)
    {
        ...
        {
            throw new Exception("不支持XML文件中提供的哈希算法。");
        }
        ...
        throw new Exception("文件完整性检查失败并报告一些错误。");
    }
